...
public class Set_password extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spinner_tips.setOnItemSelectedListener(new Set_password.spinnerListener());
    ...
    class spinnerListener implements android.widget.AdapterView.OnItemSelectedListener {
        ...
        public void onItemSelected(AdapterView<?> parent, View view,
            ...
            if (select_tip.equals("不设置提示")) {
                ...
                TextView textView = new TextView(Set_password.this);
                ...
                LinearLayout tips_out = findViewById(R.id.tips_out);//布局文件
                TextView textView = new TextView(Set_password.this);
                EditText editText = new EditText(Set_password.this);
                tips_out.removeAllViews();//清除所有布局
                tips_out.addView(textView);
                ...
                button.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        AlertDialog.Builder recAudio = new AlertDialog.Builder(Set_password.this);
                        recAudio.setTitle("录音界面");
                        recAudio.setPositiveButton("开始/重新录音", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
                                Toast.makeText(Set_password.this, "开始录音", Toast.LENGTH_SHORT).show();
                                AlertDialog.Builder recordingAudio = new AlertDialog.Builder(Set_password.this);
                                recordingAudio.setTitle("正在录音");
                                recordingAudio.setPositiveButton("结束录音", new DialogInterface.OnClickListener() {
                                    @Override
                                    public void onClick(DialogInterface dialog, int which) {
                                        stopRecord();
                                        Toast.makeText(Set_password.this, "录音已保存", Toast.LENGTH_SHORT).show();
                                    }
                                });
                                startRecord();
                        ...
                        recAudio.setNeutralButton("播放录音", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
                                Toast.makeText(Set_password.this, "正在播放", Toast.LENGTH_SHORT).show();
                                ...
                                player.start();
                                Toast.makeText(Set_password.this, "播放结束", Toast.LENGTH_SHORT).show();
                            }
                        });
                        recAudio.show();
                    }
                ...
                button.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        AlertDialog.Builder Dialog = new AlertDialog.Builder(Set_password.this);
    ...
    public void startRecord() {
        // 开始录音
        File appDir = new File(Set_password.this.getExternalFilesDir(null).getPath()+ "Audio/");//创建录音文件夹
        if (!appDir.exists()) {
            appDir.mkdir();
        }
